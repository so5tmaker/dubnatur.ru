...
function loadSection()
{
    ...
    //var blbl = createSingleBorder(document.getElementById("menu"), "single", "AAAAA");
    //blbl.innerHTML = "SDFAS DF ASD FASDF";
}
...
function loadPageTitle(section)
{
    ...
    callService("http://www.remote.bronni.ru/CountryStudy/WS/Issue.asmx/GetIssueName",
...
function parseQueryString()
{
    ...
    var strParams = strQuery.match(reParams);
    
    for(var i = 0; i< strParams.length;i++)
    {
        result[strParams[i].split("=")[0].toLowerCase()] =
         strParams[i].split("=")[1];
    }
    return result;
}
