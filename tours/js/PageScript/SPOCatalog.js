...
{   
    ...
    RenderItemsComboBox(destinationCountriesDS, comboDestinationCountry, []);
    comboDestinationCountry.setValue(0, true);
}
...
function citiesLoaded()
{
    ...
    RenderItemsComboBox(departureCitiesDS, comboDepartureCity, []);
    comboDepartureCity.setValue(0, true);
}
